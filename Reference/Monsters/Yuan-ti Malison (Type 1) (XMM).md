...
subClass:
 - "CR 3"
cover: "Yuan-ti Malison (Type 1).png"
campaign:
locations:
tags:
  - race/monstrosity
...
**Bite.** m +5, reach 5 ft. *Hit:* 5 (1d4 + 3) Piercing damage plus 7 (2d6) Poison damage.

**Poison Ray (Yuan-ti Form Only).** r +5, range 120 ft. *Hit:* 12 (2d8 + 3) Poison damage.
