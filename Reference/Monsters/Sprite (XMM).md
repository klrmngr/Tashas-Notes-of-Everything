...
**Heart Sight.** cha DC 10, one creature within 5 feet the sprite can see (Celestials, Fiends, and Undead automatically fail the save).  The sprite knows the target's emotions and alignment.
